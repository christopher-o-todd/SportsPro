...
namespace SportsPro.Controllers
{
    ...
    public class RegistrationController : Controller
    {
        ...
        // method to display a dropdown menu to show customer names so that products registered under their names can later be shown
        ...
        // list products registered to a selected customer
        [HttpGet]
        ...
        // method to add a new product to a customer
        [HttpPost]
        ...
        // method to delete a product from a customer
        [HttpGet]
